...
<body>
    <div class="wrapper" ms-controller="contents">
        ...
        <ol class="carousel-indicators" >
          <li ms-for="($index,el) in _pics" data-target="#carousel-example-generic"
          ms-attr="{'data-slide-to':$index}" ms-class="[$index == 0 ? 'active' : '']" ></li>
        </ol>

        <!-- Wrapper for slides -->
        <div class="carousel-inner" role="listbox">
          <div ms-class="[($index == 0 ? 'active' : ''), 'item']" ms-for="($index,el) in _pics">
            <img ms-attr="{src:'<?php echo base_url('files/')?>'+el}" alt="...">
